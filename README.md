...
The broker can record every completed/failed lease and every meter event to
Postgres for reconciliation and incident review. It is off by default and
adds no required dependency. Set `DATABASE_URL` and run
